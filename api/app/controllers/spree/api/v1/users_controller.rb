  ...
  module Api
    module V1
      class UsersController < Spree::Api::BaseController
        ...
        def users_with_ship_address
          @users.with_address(params[:q][:ship_address_firstname_start])
        end

        def users_with_bill_address
          @users.with_address(params[:q][:ship_address_firstname_start], :bill_address)
        end
